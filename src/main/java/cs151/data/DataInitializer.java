...
public class DataInitializer {
    ...
    public static void initializeData() {
        ...
        List<Student> existing = studentDao.getAllStudentsSortedByName();
        if (existing.size() >= 6) {
            System.out.println("Database already initialized with students.");
            return;
        }
    ...
    private static void createWhitelistedStudents() {
        ...
        alice.setRole("Full-Stack Developer");
        ...
        carol.setRole("Database Administrator");
    ...
    private static void createBlacklistedStudents() {
        ...
        david.setRole("Frontend Developer");
        ...
        emma.setRole("Software Engineer");
